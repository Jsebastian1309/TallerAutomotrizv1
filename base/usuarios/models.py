...
class Usuario(models.Model):
    ...
    tipo_usuario=models.CharField(max_length=13,choices=TipoUsuario.choices,verbose_name="Tipo Usuario",default='',blank=False)
    telefono= models.CharField(max_length=11,verbose_name="Telefono",validators=[numeric_validator],blank=False)
    correo_personal= models.EmailField(max_length=50,verbose_name="Correo Personal",blank=True)
