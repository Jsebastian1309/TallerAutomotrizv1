...
class Servicio(models.Model):
    fecha_servicio= models.DateField(verbose_name="Fecha de Registro", help_text="MM/DD/AAAA",default=timezone.now)
    ...
    kilometraje = models.IntegerField( verbose_name="Kilometraje",default="")
